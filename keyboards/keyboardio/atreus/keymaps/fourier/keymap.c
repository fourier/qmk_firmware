...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT( /* [> FN <] */
    ...
    KC_LPRN, KC_MINS, A_RIGHT, KC_EQL,  KC_RPRN,                   KC_EQL,  KC_LEFT, KC_DOWN,    KC_RIGHT,  KC_PLUS,
   ...
   */
  [_SU] = LAYOUT( /* [> SUPER <] */
    KC_INS,  KC_7, KC_8, KC_9, KC_PSCR,                   KC_UP,   KC_F7,   KC_F8,   KC_F9,   KC_F10  ,
    KC_DEL,  KC_4, KC_5, KC_6, KC_SCRL,                   KC_DOWN, KC_F4,   KC_F5,   KC_F6,   KC_F11  ,
    KC_NO,   KC_1, KC_2, KC_3, KC_0,    _______, _______, KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F12  ,
